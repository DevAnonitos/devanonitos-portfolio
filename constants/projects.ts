...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      'A high-performance organic marketplace built with Next.js 14, focusing on core web vitals and seamless Stripe integration.',
    image:
  ...
  },
  {
    ...
    description:
      'An advanced data visualization dashboard that processes real-time neural network metrics using Python and React.',
    image:
  ...
  },
  {
    ...
    description:
      'A cross-platform mobile application for tracking vital signs and connecting with healthcare providers via secure WebSockets.',
    image:
      'https://images.unsplash.com/photo-1576091160550-2173dad99a01?q=80&w=1600&auto=format&fit=crop',
  ...
  },
  {
    ...
    title: 'Zenith UI Kit',
    description:
      'A premium design system and component library focused on accessibility and ultra-modern glassmorphism aesthetics.',
    image:
      'https://images.unsplash.com/photo-1613909209435-24a39f3ebd6c?q=80&w=1600&auto=format&fit=crop',
  ...
  },
  {
    ...
    description:
      'Secure, decentralized finance dashboard for managing multi-chain assets with real-time price tracking and swaps.',
    image:
  ...
  },
  {
    ...
    description:
      'An open-source cloud management engine for orchestrating microservices across hybrid cloud environments.',
    image:
...
export const RESEARCHS: Research[] = [
  {
    ...
    description:
      'A whitepaper on the integration of AI models at the edge for low-latency healthcare applications.',
