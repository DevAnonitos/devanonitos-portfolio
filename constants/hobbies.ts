import { BookText, Camera, Dumbbell, Gamepad2, Map, Music } from 'lucide-react'
...
export const HOBBIES = [
  ...
  },
  {
    ...
    description:
      'Crafting lo-fi beats and experimental sounds to unwind after deep coding sessions.',
    icon: Music,
  ...
  },
  {
    title: 'Gym & Fitness',
    description:
      'Maintaining a balanced lifestyle through rigorous training and physical discipline.',
    icon: Dumbbell,
  ...
  },
  {
    title: 'Tech Reading',
    description:
      'Staying ahead of the curve by diving into whitepapers and architectural deep dives.',
    icon: BookText,
